...
<head>
    ...
    <title>Edit Profile — HimRishtey</title>
        ...
        <div class="ep-page-header">
            ...
            <div class="ep-overall-completion">
                ...
                <div class="ep-completion-bar-wrap">
                    <div class="ep-completion-bar" style="width: 65%"></div>
                </div>
                <span class="ep-completion-pct">65%</span>
            </div>
        </div>
            ...
            <div class="ep-tab-content">
                        ...
                        <div class="ep-field-group">
                            ...
                            <div class="ep-select-wrapper">
                                <select class="ep-select" id="employed_in" name="employed_in">
                                    <option value="">Select</option>
                                    <option value="Government" @selected(old('employed_id', $member->employed_in) == 'Government')>Government</option>
                                    <option value="Private" @selected(old('employed_id', $member->employed_in) == 'Private')>Private</option>
                                    <option value="Business" @selected(old('employed_id', $member->employed_in) == 'Business')>Business / Self Employed</option>
                                    <option value="Defense" @selected(old('employed_id', $member->employed_in) == 'Defense')>Defense</option>
                                    <option value="Not Working" @selected(old('employed_id', $member->employed_in) == 'Not Working')>Not Working</option>
                                </select>
                                <i data-lucide="chevron-down" width="16" height="16" class="ep-select-icon"></i>
                            </div>
                        </div>
                        ...
                        <div class="ep-field-group">
                            ...
                            <div class="ep-select-wrapper">
                                <select class="ep-select" id="occupation" name="occupation">
                                    <option value="">Select</option>
                                    <option value="Software Engineer" @selected(old('occupation', $member->occupation) == 'Software developer')>Software Engineer</option>
                                    <option value="Doctor" @selected(old('occupation', $member->occupation) == 'Doctor')>Doctor</option>
                                    <option value="Teacher" @selected(old('occupation', $member->occupation) == 'Teacher')>Teacher</option>
                                    <option value="Lawyer" @selected(old('occupation', $member->occupation) == 'Lawyer')>Lawyer</option>
                                    <option value="Banker" @selected(old('occupation', $member->occupation) == 'Banker')>Banker</option>
                                    <option value="Businessman" @selected(old('occupation', $member->occupation) == 'Businessman')>Businessman</option>
                                    <option value="Farmer" @selected(old('occupation', $member->occupation) == 'Farmer')>Farmer</option>
                                    <option value="Nurse" @selected(old('occupation', $member->occupation) == 'Nurse')>Nurse</option>
                                    <option value="Architect" @selected(old('occupation', $member->occupation) == 'Architect')>Architect</option>
                                    <option value="Other" @selected(old('occupation', $member->occupation) == 'Other'>Other</option>
                                </select>
                                <i data-lucide="chevron-down" width="16" height="16" class="ep-select-icon"></i>
                            </div>
                        </div>
                ...
                <section class="ep-tab-panel" id="tab-family" role="tabpanel" hidden>
                    ...
                    <form class="ep-form" id="form-family" data-section="family" novalidate>
                        <div class="ep-field-group ep-full-width">
                            ...
                            <textarea class="ep-textarea" id="about_family" name="about_family" rows="3" placeholder="Brief about your family background...">{{old('about_family', $member->about_family)}}</textarea>
                        </div>
                        ...
                        <div class="ep-field-group">
                            ...
                            <div class="ep-select-wrapper">
                                <select class="ep-select" id="family_status" name="family_status">
                                    <option value="">Select</option>
                                    <option value="Middle Class" @selected(old('family_status', $member->family_status) == 'Middle Class')>Middle Class</option>
                                    <option @selected(old('family_status', $member->family_status) == 'Upper Middle Class')>Upper Middle Class</option>
                                    <option @selected(old('family_status', $member->family_status) == 'Rich / Affluent')>Rich / Affluent</option>
                                    <option @selected(old('family_status', $member->family_status) == 'High Class')>High Class</option>
                                </select>
                                <i data-lucide="chevron-down" width="16" height="16" class="ep-select-icon"></i>
                            </div>
                        </div>
                ...
                <section class="ep-tab-panel" id="tab-preferences" role="tabpanel" hidden>
                    ...
                    <form class="ep-form" id="form-preferences" data-section="preferences" novalidate>
                        ...
                        <!-- Age Range -->
                        <div class="ep-field-group ep-full-width">
                            <label class="ep-label">Age Range: <strong id="age-range-label">18 – 35</strong> years</label>
                            <div class="ep-range-row">
                                <input type="range" class="ep-range" id="age_from" name="partner_age_from" min="18" max="70" value="18" step="1">
                                <input type="range" class="ep-range" id="age_to" name="partner_age_to" min="18" max="70" value="35" step="1">
                            </div>
                        </div>

                        <!-- Height Range -->
                        <div class="ep-field-group ep-full-width">
                            <label class="ep-label">Height Range: <strong id="height-range-label">4'6" – 5'6"</strong></label>
                            <div class="ep-range-row">
                                <input type="range" class="ep-range" id="height_from" name="partner_height_from" min="1" max="28" value="1" step="1">
                                <input type="range" class="ep-range" id="height_to" name="partner_height_to" min="1" max="28" value="14" step="1">
                            </div>
                        </div>

                        <!-- Income Range -->
                        <div class="ep-field-group ep-full-width">
                            <label class="ep-label">Annual Income Range: <strong id="income-range-label">0 – 10 LPA</strong></label>
                            <div class="ep-range-row">
                                <input type="range" class="ep-range" id="income_from" name="partner_annual_income_from" min="0" max="50" value="0" step="1">
                                <input type="range" class="ep-range" id="income_to" name="partner_annual_income_to" min="0" max="50" value="10" step="1">
                            </div>
                        </div>
