    ...
    <div class="sidebar-header">
      <div class="sidebar-profile-card" onclick="window.location='#'">
        <div class="sidebar-avatar-wrap">
          <img
            src="{{Auth::user()->photo ? asset('photos/photo/' . Auth::user()->photo) : asset('images/default-avatar.png')}}"
    ...
    <div class="navbar-inner container-fluid">
      ...
      <div class="navbar-right">
        ...
        <button class="profile-avatar-btn" id="profileQuickViewBtn" aria-label="Open profile quick view" aria-expanded="false" aria-controls="profileQuickView">
          <img src="{{Auth::user()->photo ? asset('photos/photo/' . Auth::user()->photo) : asset('images/default-avatar.png')}}" alt="{{ Auth::user()->name ?? 'User' }}" width="40" height="40" class="navbar-avatar" loading="lazy" id="profileAvatar" />
    ...
    <div class="pqv-inner">
      ...
      <div class="pqv-user-row">
        <div class="pqv-avatar-wrap">
          <img src="{{Auth::user()->photo ? asset('photos/photo/' . Auth::user()->photo) : asset('images/default-avatar.png')}}" alt="{{ Auth::user()->name ?? 'User' }}" width="60" height="60" loading="lazy" class="pqv-avatar" id="profileAvatar" />
