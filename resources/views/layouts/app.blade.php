...
<head>
  ...
  <title>@yield('title', 'HimRishtey – Himachal\'s Most Trusted Matrimony')</title>
  <meta name="description" content="@yield('description', 'Him Rishtey is Himachal Pradesh\'s most trusted matrimonial service. Connect with Himachali brides and grooms across all castes and communities.')" />
